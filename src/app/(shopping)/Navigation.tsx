...
import { useCommand } from '@/app/(shopping)/components/CommandContext'

const createHref = (category?: Category, section?: Section, item?: Item) => {
  let href = '/shop'
            ...
            <div className='flex h-16 items-center'>
              ...
              <div className='ml-auto flex items-center'>
                ...
                <div className='flex lg:ml-6'>
                  <button
                    onClick={() => command.openModal(null)}
